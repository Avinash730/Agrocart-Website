      ...
      <div className="w-[100%]">
        <div className="w-[90%] my-10  mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-6 ">
            ...
            <Link className="flex items-center rounded-md bg-emerald-500 px-3.5 py-2.5 shadow-md text-white hover:bg-emerald-400">
              जानें कि मृदा स्वास्थ्य का प्रबंधन कैसे करें
            </Link>
          </div>
        </div>
      </div>
